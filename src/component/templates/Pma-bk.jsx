...
import Doc from './printPDF/docService';
import PdfContainer from './printPDF/pdfContainer';
// import './sheets-of-pma.less';
// import './pmaPDFstyle.css';
import './style.css';
...
function Pma() {
    ...
    class PmaTemplate extends React.Component {

        render() {
            return (
                <div>
                    <div id="page-border"><div id="page-outline"></div></div>
...
export default class PmaTemplate extends React.Component {
    pdfExportComponent;
    ...
    render() {
        ...
        return (
            <Fragment>
                <button className="btn btn-primary" onClick={() => this.pdfExportComponent.save()}>Save as PDF</button>
                <PDFExport
                    paperSize="Legal"
                    margin="1cm"
                ...
                >
                    <kendo-pdf-document><div>
                        <kendo-pdf-document><div id="pageborder"></div></kendo-pdf-document>
                        <kendo-pdf-document><div className="page page-size-legal">
                            <kendo-pdf-document><p className="pma-details">
                ...
                </p></kendo-pdf-document>
                            <kendo-pdf-document><p className="newspaper">
